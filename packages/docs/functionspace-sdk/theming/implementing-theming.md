...
#### Theme System <a href="#theme-system-1" id="theme-system-1"></a>

**Types**

<table><thead><tr><th width="242.8984375">Type</th><th>Description</th></tr></thead><tbody><tr><td><code>FSTheme</code></td><td>Full 30-token theme interface (9 core required, 21 optional derived tokens)</td></tr><tr><td><code>ResolvedFSTheme</code></td><td><code>Required&#x3C;FSTheme></code> — all 30 tokens guaranteed present</td></tr><tr><td><code>FSThemeInput</code></td><td>Flexible input: preset name string, full theme object, or partial with <code>preset</code> base</td></tr><tr><td><code>ThemePresetId</code></td><td><code>'fs-dark' | 'fs-light' | 'native-dark' | 'native-light'</code></td></tr><tr><td><code>ChartColors</code></td><td>Concrete hex values for SVG rendering (grid, axis, tooltip, consensus, preview, payout, positions, fanBands)</td></tr><tr><td><code>FanBandColors</code></td><td>Five opacity-variant colors for fan chart bands (mean, band25, band50, band75, band95)</td></tr></tbody></table>

**Preset Constants**

<table><thead><tr><th width="240.1953125">Constant</th><th>Description</th></tr></thead><tbody><tr><td><code>FS_DARK</code></td><td>FunctionSpace branded dark theme. Blue primary, dark purple background.</td></tr><tr><td><code>FS_LIGHT</code></td><td>FunctionSpace branded light theme. Blue primary, light gray background.</td></tr><tr><td><code>NATIVE_DARK</code></td><td>De-branded dark theme. System fonts, compact radius, fast transitions.</td></tr><tr><td><code>NATIVE_LIGHT</code></td><td>De-branded light theme. System fonts, compact radius.</td></tr><tr><td><code>THEME_PRESETS</code></td><td>Metadata array for theme-selector UIs: <code>{ id, label, group }[]</code></td></tr></tbody></table>

**Functions**

<table><thead><tr><th width="359.80078125">Function</th><th>Description</th></tr></thead><tbody><tr><td><code>resolveChartColors(theme, presetOverrides?, customOverrides?)</code></td><td>Produces a <code>ChartColors</code> object from a resolved theme with optional overrides.</td></tr><tr><td><code>getPresetChartColors(presetId)</code></td><td>Returns preset-specific chart color overrides.</td></tr></tbody></table>
...
1. **CSS Custom Properties** (`--fs-*`) — Used by all HTML/DOM elements (panels, buttons, inputs, tables). The Provider injects these as inline styles on a wrapper `<div>`.
...
### Approach Options <a href="#approach-options" id="approach-options"></a>

#### Option 1: Preset Only <a href="#option-1-preset-only" id="option-1-preset-only"></a>
...
#### Option 2: Preset + Overrides <a href="#option-2-preset--overrides" id="option-2-preset--overrides"></a>
...
#### Option 3: Fully Custom (Core 9) <a href="#option-3-fully-custom-core-9" id="option-3-fully-custom-core-9"></a>
...
#### Option 4: Fully Custom (All 30) <a href="#option-4-fully-custom-all-30" id="option-4-fully-custom-all-30"></a>
...
### Token Reference — Core 9 (Required) <a href="#token-reference--core-9-required" id="token-reference--core-9-required"></a>
...
#### `accent` <a href="#accent" id="accent"></a>
...
#### `textSecondary` <a href="#textsecondary" id="textsecondary"></a>
...
### Token Reference — Tier 1 (Optional, Derived from Core 9) <a href="#token-reference--tier-1-optional-derived-from-core-9" id="token-reference--tier-1-optional-derived-from-core-9"></a>
...
#### `bgSecondary` <a href="#bgsecondary" id="bgsecondary"></a>
...
#### `surfaceHover` <a href="#surfacehover" id="surfacehover"></a>
...
#### `borderSubtle` <a href="#bordersubtle" id="bordersubtle"></a>
...
#### `textMuted` <a href="#textmuted" id="textmuted"></a>
...
### Token Reference — Tier 2 (Optional, Component-Specific) <a href="#token-reference--tier-2-optional-component-specific" id="token-reference--tier-2-optional-component-specific"></a>

These tokens are consumed by specific components. All have sensible defaults.

#### `inputBg` <a href="#inputbg" id="inputbg"></a>
...
#### `chartBg` <a href="#chartbg" id="chartbg"></a>
...
#### `navFrom` / `navTo` <a href="#navfrom--navto" id="navfrom--navto"></a>
...
#### `accentGlow` <a href="#accentglow" id="accentglow"></a>
...
#### `badgeBg` / `badgeBorder` / `badgeText` <a href="#badgebg--badgeborder--badgetext" id="badgebg--badgeborder--badgetext"></a>
...
#### `codeBg` <a href="#codebg" id="codebg"></a>
...
#### `logoFilter` <a href="#logofilter" id="logofilter"></a>
...
### Token Reference — Tier 3 (Shape & Personality) <a href="#token-reference--tier-3-shape--personality" id="token-reference--tier-3-shape--personality"></a>

These tokens control the overall feel — rounded vs sharp, fast vs relaxed, branded font vs system font.

#### `fontFamily` <a href="#fontfamily" id="fontfamily"></a>
...
#### `radiusSm` / `radiusMd` / `radiusLg` <a href="#radiussm--radiusmd--radiuslg" id="radiussm--radiusmd--radiuslg"></a>
...
#### `borderWidth` <a href="#borderwidth" id="borderwidth"></a>
...
#### `transitionSpeed` <a href="#transitionspeed" id="transitionspeed"></a>
...
### Chart Color Overrides <a href="#chart-color-overrides" id="chart-color-overrides"></a>
...
#### Default Chart Color Derivation <a href="#default-chart-color-derivation" id="default-chart-color-derivation"></a>
...
#### When to Override <a href="#when-to-override" id="when-to-override"></a>
...
#### How to Override (Future API) <a href="#how-to-override-future-api" id="how-to-override-future-api"></a>
...
### Derived CSS Variables <a href="#derived-css-variables" id="derived-css-variables"></a>
...
### Resolution Logic <a href="#resolution-logic" id="resolution-logic"></a>
...
### Complete Example: Finance Platform Dark Theme <a href="#complete-example-finance-platform-dark-theme" id="complete-example-finance-platform-dark-theme"></a>
...
### Complete Example: Light Editorial Theme <a href="#complete-example-light-editorial-theme" id="complete-example-light-editorial-theme"></a>
...
### Preset Comparison <a href="#preset-comparison" id="preset-comparison"></a>
...
The "native" presets are designed to disappear into a host application. The "fs" presets are designed to feel like a FunctionSpace product.<br>
