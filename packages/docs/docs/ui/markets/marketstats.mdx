...
title: "MarketStats"
sidebar_position: 1
description: "MarketStats widget displaying total volume, liquidity, open positions, and market status."
---
...
<WidgetDemo title="Live Demo" height="80px">
...
| Market Status     | `market.resolutionState` | `'open'` to "Active", all others to "Resolved" |
