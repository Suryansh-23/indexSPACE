...
title: "TimelineChart"
sidebar_position: 4
description: "TimelineChart fan chart showing consensus evolution over time with confidence interval bands."
---
...
<WidgetDemo title="Live Demo" height="350px">
  <TimelineChart marketId={DEMO_MARKET_ID} height={300} />
</WidgetDemo>
