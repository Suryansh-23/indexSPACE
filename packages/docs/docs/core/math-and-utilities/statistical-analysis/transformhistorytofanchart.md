...
**`transformHistoryToFanChart(snapshots, lowerBound, upperBound, maxPoints?)`**
...
const fanData = transformHistoryToFanChart(history.snapshots, lowerBound, upperBound, 200);
