...
- Data-fetching hooks (NOT `useAuth`) reference `ctx.invalidationCount`
- Returns `{ <named>, loading, error, refetch }` shape
...
### 5. Verify CSS variable compliance
...
### 6. Check derived-variables selector
